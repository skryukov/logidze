...
describe Logidze::Generators::InstallGenerator, type: :generator do
  ...
  describe "trigger migration" do
    ...
    it "creates migration", :aggregate_failures do
      ...
      is_expected.to contain(/create or replace function logidze_append/i)
    end
    ...
    context "when using fx" do
      ...
      it "creates migration", :aggregate_failures do
        ...
        is_expected.to contain("create_function :logidze_append, version: 1")
        ...
        is_expected.to contain("DROP FUNCTION IF EXISTS logidze_append")
      end
