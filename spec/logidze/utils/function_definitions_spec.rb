...
describe Logidze::Utils::FunctionDefinitions do
  describe ".from_fs" do
    ...
    it "returns all library functions" do
      ...
      is_expected.to include(func_def("logidze_append", 1, "jsonb, jsonb, timestamp with time zone, integer, integer, text[], boolean"))
    end
  end
  ...
  describe ".from_db" do
    ...
    it "returns all functions from db without signatures" do
      ...
      is_expected.to include(func_def("logidze_append", 1))
    end
  end
